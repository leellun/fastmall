...
import com.newland.mall.config.UserServiceErrorEnum;
...
import com.newland.mall.enums.MenuTypeEnum;
...
import com.newland.mall.model.vo.MenuVo;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public void deleteMenu(Set<Long> ids) {
        ...
        List<Long> waitDeleteIds = getSuperior(ids);
        int count = baseMapper.deleteBatchIds(waitDeleteIds);
    ...
    public List<String> getPermissions(Long userId) {
        List<SysRole> roles = sysRoleMapper.getRoleWithIdByUserId(userId, BasicEnum.YES.getKey());
    ...
    public List<SysMenu> getUserMenus() {
        ...
        List<SysRole> roles = sysRoleMapper.getRoleWithIdByUserId(loginUser.getUserId(), BasicEnum.YES.getKey());
