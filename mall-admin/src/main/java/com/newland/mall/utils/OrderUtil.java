...
public class OrderUtil {
    ...
    public static List<Integer> orderStatus(Integer showType) {
        ...
        OrderShowTypeEnum showTypeEnum = OrderShowTypeEnum.valueOf(showType);
        switch (showTypeEnum) {
            case PENDING_PAYMENT -> status.add(OrderStatusEnum.STATUS_CREATE.getKey());
            case PENDING_DELIVER -> status.add(OrderStatusEnum.STATUS_PAY.getKey());
            case PENDING_TAKE -> status.add(OrderStatusEnum.STATUS_SHIP.getKey());
            case PENDING_COMMENT -> status.add(OrderStatusEnum.STATUS_CONFIRM.getKey());
            default -> {
                return null;
            }
        }
    ...
    public static boolean isRefundConfirmStatus(Order Order) {
        return OrderUtil.STATUS_REFUND_CONFIRM.equals(Order.getOrderStatus());
    }

    public static boolean isAutoConfirmStatus(Order Order) {
        return OrderUtil.STATUS_AUTO_CONFIRM.equals(Order.getOrderStatus());
    }
}
